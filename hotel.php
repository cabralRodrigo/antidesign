                ...
                <div class="swiper-slide">
                    <div>
                        <div class="c-hotel__banner__img" style="background-image:url('assets/img/hotel/hotel1.jpg');">
                            <a href="assets/img/hotel/hotel1.jpg" class="c-hotel__banner__img__lightbox" data-lightbox="banner" data-title="My caption"><svg xmlns="http://www.w3.org/2000/svg" width="20.645" height="20.688">
                                    <g data-name="Grupo 551">
                                        <path data-name="Caminho 176" d="M17.858 1.591h-2.726a.8.8 0 110-1.591h4.688a.772.772 0 01.825.82v4.722a.794.794 0 11-1.587-.013V2.736c-.095.089-.157.144-.216.2l-4.7 4.71a.867.867 0 01-.65.307.751.751 0 01-.711-.451.766.766 0 01.094-.84 2.134 2.134 0 01.188-.2q2.314-2.32 4.631-4.638a1.626 1.626 0 01.22-.158z" />
                                        <path data-name="Caminho 177" d="M1.588 17.951c.1-.1.168-.155.23-.216l4.7-4.709a.819.819 0 011.073-.166.8.8 0 01.167 1.176c-.079.1-.171.18-.258.268l-4.594 4.6c-.046.046-.09.095-.161.17.1.008.166.018.234.018h2.555a.8.8 0 11.007 1.59H.804a.77.77 0 01-.8-.817v-4.722a.794.794 0 111.587.006v2.51c-.003.083-.003.162-.003.292z" />
                                    </g>
                                </svg></a>
                        </div>
                    </div>
                    <div>
                        <div class="c-hotel__banner__img" style="background-image:url('assets/img/hotel/hotel2.jpg');">
                            <a href="assets/img/hotel/hotel2.jpg" class="c-hotel__banner__img__lightbox" data-lightbox="banner" data-title="My caption"><svg xmlns="http://www.w3.org/2000/svg" width="20.645" height="20.688">
                                    <g data-name="Grupo 551">
                                        <path data-name="Caminho 176" d="M17.858 1.591h-2.726a.8.8 0 110-1.591h4.688a.772.772 0 01.825.82v4.722a.794.794 0 11-1.587-.013V2.736c-.095.089-.157.144-.216.2l-4.7 4.71a.867.867 0 01-.65.307.751.751 0 01-.711-.451.766.766 0 01.094-.84 2.134 2.134 0 01.188-.2q2.314-2.32 4.631-4.638a1.626 1.626 0 01.22-.158z" />
                                        <path data-name="Caminho 177" d="M1.588 17.951c.1-.1.168-.155.23-.216l4.7-4.709a.819.819 0 011.073-.166.8.8 0 01.167 1.176c-.079.1-.171.18-.258.268l-4.594 4.6c-.046.046-.09.095-.161.17.1.008.166.018.234.018h2.555a.8.8 0 11.007 1.59H.804a.77.77 0 01-.8-.817v-4.722a.794.794 0 111.587.006v2.51c-.003.083-.003.162-.003.292z" />
                                    </g>
                        ...
                        <div class="c-hotel__banner__img" style="background-image:url('assets/img/hotel/hotel3.jpg');">
                            <a href="assets/img/hotel/hotel3.jpg" class="c-hotel__banner__img__lightbox" data-lightbox="banner" data-title="My caption"><svg xmlns="http://www.w3.org/2000/svg" width="20.645" height="20.688">
                                    <g data-name="Grupo 551">
                                        <path data-name="Caminho 176" d="M17.858 1.591h-2.726a.8.8 0 110-1.591h4.688a.772.772 0 01.825.82v4.722a.794.794 0 11-1.587-.013V2.736c-.095.089-.157.144-.216.2l-4.7 4.71a.867.867 0 01-.65.307.751.751 0 01-.711-.451.766.766 0 01.094-.84 2.134 2.134 0 01.188-.2q2.314-2.32 4.631-4.638a1.626 1.626 0 01.22-.158z" />
                                        <path data-name="Caminho 177" d="M1.588 17.951c.1-.1.168-.155.23-.216l4.7-4.709a.819.819 0 011.073-.166.8.8 0 01.167 1.176c-.079.1-.171.18-.258.268l-4.594 4.6c-.046.046-.09.095-.161.17.1.008.166.018.234.018h2.555a.8.8 0 11.007 1.59H.804a.77.77 0 01-.8-.817v-4.722a.794.794 0 111.587.006v2.51c-.003.083-.003.162-.003.292z" />
                                    </g>
                ...
                <div class="swiper-slide">
                    <div>
                        <div class="c-hotel__banner__img" style="background-image:url('assets/img/hotel/hotel4.jpg');">
                            <a href="assets/img/hotel/hotel4.jpg" class="c-hotel__banner__img__lightbox" data-lightbox="banner" data-title="My caption"><svg xmlns="http://www.w3.org/2000/svg" width="20.645" height="20.688">
                                    <g data-name="Grupo 551">
                                        <path data-name="Caminho 176" d="M17.858 1.591h-2.726a.8.8 0 110-1.591h4.688a.772.772 0 01.825.82v4.722a.794.794 0 11-1.587-.013V2.736c-.095.089-.157.144-.216.2l-4.7 4.71a.867.867 0 01-.65.307.751.751 0 01-.711-.451.766.766 0 01.094-.84 2.134 2.134 0 01.188-.2q2.314-2.32 4.631-4.638a1.626 1.626 0 01.22-.158z" />
                                        <path data-name="Caminho 177" d="M1.588 17.951c.1-.1.168-.155.23-.216l4.7-4.709a.819.819 0 011.073-.166.8.8 0 01.167 1.176c-.079.1-.171.18-.258.268l-4.594 4.6c-.046.046-.09.095-.161.17.1.008.166.018.234.018h2.555a.8.8 0 11.007 1.59H.804a.77.77 0 01-.8-.817v-4.722a.794.794 0 111.587.006v2.51c-.003.083-.003.162-.003.292z" />
                                    </g>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 offset-xl-1">
                    <div class="c-hotel__reservar natural shadow" id="price">
                        ...
                        <div>
                            <button type="button" class="btn btn-link px-0 fw-500 mb-5" data-bs-toggle="modal" data-bs-target="#modal505">Selecione a melhor opção</button>
                ...
                <div class="col-xl-3 c-cards-carousel__title">
                    ...
                    <div class="position-relative c-cards-carousel__pagination">
                        ...
                        <div class="swiper-button-prev fs-4 shadow rounded-circle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8.397" height="14.73">
                                <path data-name="Caminho 4" d="M8.396 7.365a1.029 1.029 0 01-.3.729l-6.337 6.337A1.032 1.032 0 01.3 12.972l5.6-5.6-5.6-5.6A1.036 1.036 0 111.759.302l6.336 6.329a1.029 1.029 0 01.301.734z" fill="#0e6a7a" />
                            </svg>
                        </div>
