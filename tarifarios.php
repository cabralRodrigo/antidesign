                        ...
                        <div class="tab-pane fade active show" id="hotelaria-rj-tabContent" role="tabpanel" aria-labelledby="hotelaria-rj-tab">
                            ...
                            <div class="row border-bottom pt-5">
                                <div class="col-xl-12">
                                    ...
                                    <p class="fs-12">
                                        <span class="o-hotel__img__item md-inline-block fw-500 me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10.965" height="10.512">
                                                <path data-name="Caminho 36" d="M6.248.476l1.033 2.093a.853.853 0 00.642.467l2.31.335a.854.854 0 01.473 1.456L9.035 6.456a.854.854 0 00-.245.755l.395 2.3a.853.853 0 01-1.238.9L5.881 9.325a.854.854 0 00-.794 0l-2.066 1.086a.853.853 0 01-1.238-.9l.395-2.3a.853.853 0 00-.246-.755L.26 4.827a.854.854 0 01.473-1.456l2.31-.335a.853.853 0 00.642-.467L4.718.476a.853.853 0 011.53 0z" fill="#0f6b7b"></path>
                                            </svg>
                                    ...
                                    <div class="c-reservas__table">
                                        <table class="table fs-6 table-striped table-borderless mt-5" id="table">
                                            <thead>
                                    ...
                                    <div class="row border-bottom">
                                        <div class="col">
                                            ...
                                            <a class="c-busca__container__controls__item text-decoration-none fs-4 text-primary fw-500 d-flex align-items-center p-3 px-0 border-0 pb-4 collapsed" data-bs-toggle="collapse" data-bs-target="#belmond-copacabana-palace-info" aria-expanded="false" aria-controls="info">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                                    <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a"></path>
                                                </svg>
                                            </a>
                            ...
                            <div class="row border-bottom pt-5">
                                <div class="col-xl-12">
                                    ...
                                    <div class="row border-bottom">
                                        <div class="col">
                                            <a class="c-busca__container__controls__item text-decoration-none fs-4 text-primary fw-500 d-flex align-items-center p-3 px-0 border-0 pb-4 collapsed" data-bs-toggle="collapse" data-bs-target="#astoria-copacabana-info" aria-expanded="false" aria-controls="info">
                                                <span class="icon-info me-3 fs-28"></span>
                                                <span class="me-3">Informações Importantes</span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                                    <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a"></path>
                            ...
                            <div class="row c-reservas__table pt-5">
                                <div class="col-xl-12">
                                    ...
                                    <div class="row border-bottom">
                                        <div class="col">
                                            <a class="c-busca__container__controls__item text-decoration-none fs-4 text-primary fw-500 d-flex align-items-center p-3 px-0 border-0 pb-4 collapsed" data-bs-toggle="collapse" data-bs-target="#atlantico-praia-info" aria-expanded="false" aria-controls="info">
                                                <span class="icon-info me-3 fs-28"></span>
                                                <span class="me-3">Informações Importantes</span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                                    <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a"></path>
