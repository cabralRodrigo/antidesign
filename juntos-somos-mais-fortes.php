                                    ...
                                    <div class="col-xxl-5 offset-xxl-6 col-xl-6 col-lg-6 offset-lg-6 ">
                                        ...
                                        <div class="accordion accordion-flush mt-5 border-top border-bottom" id="accordion-hospedagens">
                                            <div class="accordion-item border-white">
                                                ...
                                                <div id="hospedagens-collapseOne" class="accordion-collapse collapse" aria-labelledby="hospedagens-headingOne">
                                            ...
                                            <div class="accordion-item border-white">
                                                ...
                                                <div id="hospedagens-collapseTwo" class="accordion-collapse collapse" aria-labelledby="hospedagens-headingTwo">
                                                    <div class="accordion-body bg-dark text-white">
                                            ...
                                            <div class="accordion-item border-white">
                                                ...
                                                <div id="hospedagens-collapseThree" class="accordion-collapse collapse" aria-labelledby="hospedagens-headingThree">
                                                    <div class="accordion-body bg-dark text-white">
                                            ...
                                            <div class="accordion-item border-white">
                                                ...
                                                <div id="hospedagens-collapseFour" class="accordion-collapse collapse" aria-labelledby="hospedagens-headingFour">
                                                    <div class="accordion-body bg-dark text-white">
                                                        <strong>This is the third item's accordion body.</strong> It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion-item border-white">
                                                ...
                                                <div id="hospedagens-collapseFive" class="accordion-collapse collapse" aria-labelledby="hospedagens-headingFive">
                                                    <div class="accordion-body bg-dark text-white">
                                                        <strong>This is the third item's accordion body.</strong> It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
                                                    </div>
                                                </div>
                                        ...
                                        <div class="border-top border-bottom border-white py-3">
                                            blabla
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-3 col-xl-6 col-md-8">
                                    ...
                                    <span class="d-flex align-items-center text-reset fw-500 mt-5">
                                        Veja as regras <svg xmlns="http://www.w3.org/2000/svg" width="8.397" height="14.73" class="ms-3">
                                            <path data-name="Caminho 4" d="M8.4 7.365a1.029 1.029 0 01-.3.729L1.761 14.43A1.033 1.033 0 01.3 12.969l5.6-5.6-5.6-5.6A1.032 1.032 0 111.759.31L8.1 6.636a1.029 1.029 0 01.3.729z" fill="#fff" />
                                        </svg>
                                    </span>
                                </div>
                            </div>
