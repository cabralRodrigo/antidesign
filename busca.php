    ...
    <section class="c-busca__container">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-2 c-busca__container__controls mb-5 JS__busca-filtros">
                    <span class="c-busca__container__controls__close JS__busca-toggleFiltros">
                        <span class="icon-close text-primary fs-22"></span>
                    </span>
                ...
                <div class="row border-bottom">
                    <div class="col">
                        ...
                        <a class="c-busca__container__controls__item text-reset fs-4 text-secondary fw-500 d-flex align-items-center justify-content-between p-3 px-0" data-bs-toggle="collapse" data-bs-target="#categoria" aria-expanded="false" aria-controls="categoria">
                            Categoria
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a" />
                            </svg>
                ...
                <div class="row border-bottom">
                    <div class="col">
                        <a class="c-busca__container__controls__item text-reset fs-4 text-secondary fw-500 d-flex align-items-center justify-content-between p-3 px-0" data-bs-toggle="collapse" data-bs-target="#hospedagem" aria-expanded="false" aria-controls="hospedagem">
                            Hospedagem
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a" />
                            </svg>
                ...
                <div class="row border-bottom">
                    <div class="col">
                        <a class="c-busca__container__controls__item text-reset fs-4  text-secondary fw-500 d-flex align-items-center justify-content-between p-3 px-0" data-bs-toggle="collapse" data-bs-target="#reembolsavel" aria-expanded="false" aria-controls="perfil-produto">
                            Reembolsável
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a" />
                            </svg>
                ...
                <div class="row border-bottom">
                    <div class="col">
                        <a class="c-busca__container__controls__item text-reset fs-4 text-secondary fw-500 d-flex align-items-center justify-content-between p-3 px-0" data-bs-toggle="collapse" data-bs-target="#perfil-produto" aria-expanded="false" aria-controls="perfil-produto">
                            Perfil de Produto
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a" />
                            </svg>
                ...
                <div class="row border-bottom">
                    <div class="col">
                        <a class="c-busca__container__controls__item text-reset fs-4  text-secondary fw-500 d-flex align-items-center justify-content-between p-3 px-0" data-bs-toggle="collapse" data-bs-target="#refeicoes" aria-expanded="false" aria-controls="perfil-produto">
                            Refeições
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a" />
                            </svg>
                ...
                <div class="row">
                    <div class="col">
                        <a class="c-busca__container__controls__item text-reset fs-4 text-secondary fw-500 d-flex align-items-center justify-content-between p-3 px-0" data-bs-toggle="collapse" data-bs-target="#servicos" aria-expanded="false" aria-controls="perfil-produto">
                            Serviços
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397">
                                <path data-name="Caminho 4" d="M7.365.001a1.029 1.029 0 01.729.3l6.337 6.337a1.032 1.032 0 01-1.459 1.459l-5.6-5.6-5.6 5.6a1.036 1.036 0 11-1.47-1.459L6.631.302a1.029 1.029 0 01.734-.301z" fill="#0e6a7a" />
                            </svg>
            ...
            <div class="col-xl-9 offset-xl-1">
                ...
                <div class="row c-busca__container__result">
                    ...
                    <div class="col-xl-3 offset-xl-1 col-xl-3 c-busca__sidebar">

                        <div class="mb-4 d-xl-none c-busca__sidebar__filtro">
                            <button class="btn btn-primary fs-6 fw-500 w-100 JS__busca-toggleFiltros d-flex align-items-center justify-content-center">
                        ...
                        <div class="c-busca__sidebar__advertisement mb-5 mb-xl-0">
