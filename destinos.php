                        ...
                        <div class="row mb-5 mt-3">
                            <div class="col-xl-10">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <button class="c-destinos__icon d-flex align-items-center border-0 fs-6 text-light bg-dark-pink p-2 px-3 rounded mb-3 me-2">
                                ...
                                <table class="table" id="table">
                                    ...
                                    <tbody class="fs-6">
                                        <tr onclick="window.open('relatorio.pdf')">
                                            <td>Bonito</td>
                                            <td class="fs-22">
                                                <span class="icon-save text-purple me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Lista Especial"></span>
                                                <span class="icon-value text-pink me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Inserção de tarifa"></span>
                                                <span class="icon-descont text-dark-pink me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Promoções"></span>
                                                <span class="icon-new-product text-info me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Novo Produto"></span>
                                            </td>
                                        ...
                                        <tr onclick="window.open('relatorio.pdf')">
                                            ...
                                            <td class="fs-22">
                                                <span class="icon-save text-purple me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Lista Especial"></span>
                                                <span class="icon-tax-increace text-danger me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Aumento de Tarifas"></span>
                                                <span class="icon-descont text-dark-pink me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Promoções"></span>
                                                <span class="icon-new-product text-info me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Novo Produto"></span>
                                            </td>
                                            <td>Inserção de tarifa de 01 de Julho a 30 de Dezembro</td>
                                        ...
                                        <tr onclick="window.open('relatorio.pdf')">
                                            ...
                                            <td class="fs-22">
                                                <span class="icon-save text-purple me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Lista Especial"></span>
                                                <span class="icon-tax-decrese text-green me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Diminuição de Tarifas"></span>
                                                <span class="icon-descont text-dark-pink me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Promoções"></span>
                                                <span class="icon-new-product text-info me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Novo Produto"></span>
                                            </td>
