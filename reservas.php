        ...
        <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 offset-md-1 d-flex align-items-center justify-content-lg-end mb-4">
                            <a class="fs-4 text-decoration-none text-primary fw-500 d-flex align-items-center c-reservas__filtros__button collapsed" data-bs-toggle="collapse" href="#filtros" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
                                ...
                                Filtros
                                <svg xmlns="http://www.w3.org/2000/svg" width="14.73" height="8.397" class="ms-3">
                                    <path data-name="Caminho 4" d="M7.366 8.397a1.029 1.029 0 01-.729-.3L.3 1.76A1.032 1.032 0 011.759.301l5.6 5.6 5.6-5.6a1.036 1.036 0 111.47 1.459L8.1 8.096a1.029 1.029 0 01-.734.301z" fill="#0e6a7a" />
                                </svg>
                            </a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-12 c-reservas__table">
                    <div>
                        <table class="table table-striped table-borderless table-hover fs-6 JS__datatable">
                            <thead>
                            ...
                            <tbody>
                                <tr data-href="reserva.php">
                                    ...
                                    <td>15/03/2021</td>
                                    <td>13/03/2021</td>
                                    <td class="c-reservas__table__status py-0">
                                        <div class="d-flex">
                                    ...
                                    <td>-</td>
                                    <td>01</td>
                                    <td class="fs-24 text-black-50 text-center py-0">
